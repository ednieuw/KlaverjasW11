...
bij de omzetting naar C# en Swift ongewijzigd gebleven, zodat je in de code kunt
...
`KlaverjasWin/Engine/` en `KlaverjasSwift/Sources/KlaverjasKit/` naast elkaar te
